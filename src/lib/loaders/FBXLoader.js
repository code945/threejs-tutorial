...
var FBXLoader = (function () {
    ...
    FBXLoader.prototype = Object.assign(Object.create(Loader.prototype), {
        ...
        load: function (url, onLoad, onProgress, onError) {
            ...
            var path =
                self.path === "" ? LoaderUtils.extractUrlBase(url) : self.path;
    ...
    FBXTreeParser.prototype = {
        ...
        parseParameters: function (materialNode, textureMap, ID) {
            ...
            connections.get(ID).children.forEach(function (child) {
                ...
                switch (type) {
                    case "Bump":
                        parameters.bumpMap = self.getTexture(
                            textureMap,
                            child.ID
                        );
                        break;
                    ...
                    case "Maya|TEX_ao_map":
                        parameters.aoMap = self.getTexture(
                            textureMap,
                            child.ID
                        );
                        break;
                    ...
                    case "Maya|TEX_normal_map":
                        parameters.normalMap = self.getTexture(
                            textureMap,
                            child.ID
                        );
                        break;
                    ...
                    case "ReflectionColor":
                        parameters.envMap = self.getTexture(
                            textureMap,
                            child.ID
                        );
                    ...
                    case "TransparentColor":
                        parameters.alphaMap = self.getTexture(
                            textureMap,
                            child.ID
                        );
                        parameters.transparent = true;
                        ...
                        if (curveNodesMap.has(child.ID)) {
                            ...
                            if (
                                ...
                                if (layerCurveNodes[i] === undefined) {
                                    ...
                                    var morpherID = connections.get(deformerID)
                                        .parents[0].ID;
                                    var geoID = connections.get(morpherID)
                                        .parents[0].ID;

                                    // assuming geometry is not used in more than one model
                                    var modelID = connections.get(geoID)
                                        .parents[0].ID;
